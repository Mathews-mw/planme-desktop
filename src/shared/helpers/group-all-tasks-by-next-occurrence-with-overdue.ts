...
export function groupAllTasksByNextOccurrenceWithOverdue({ tasks, now = new Date() }: { tasks: ITask[]; now?: Date }) {
	...
	for (const g of groups) {
		g.items.sort((a, b) => {
			...
			// Se for overdue, você pode querer ordenar “mais atrasado primeiro”
